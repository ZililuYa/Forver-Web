<template>
  <div class="row mom">
    <h3>须知</h3>
    <hr>
    <p>本组件库是基于 Bootstrap jQuery 构建</p>
    <p>已经包含的有 <a target="_blank" href="http://www.bootcss.com/">Bootstrap</a> , <a target="_blank"
                                                                                   href="http://fontawesome.dashgame.com/">Font Awesome</a>
      和 jQuery</p>
    ...
    <div class="canvas">
      ...
      <span class="for">FORVER BETA</span>
    </div>
  </div>
</template>
